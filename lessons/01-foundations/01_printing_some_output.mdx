...
A string can contain whitespace, so it can represent a single word or a sentence.
...
In the examples above we used **single quotes** (`' ... '`). You can use **double quotes** as well. That's useful if you want to include single quotes as part of the text you are representing, for instance:

```js
console.log("It's time to discuss something more interesting!");
```
:::

...
Why are data types important? Mostly because of the operations defined on the set of their possible values. Without knowing that two values are numeric, would the plus operator make sense? Can you add five to yellow? We as humans certainly not, but JavaScript has some ideas!

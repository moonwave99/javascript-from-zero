...
There is a lot of theory to discuss about variables, but we don't have time for it now. Let's really use them as scrapes of paper where we can scribble on.
...
They are called **variable initialisations**. More in detail they are made of:

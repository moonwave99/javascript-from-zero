...
```js live showConsole showLines interactive defer consoleEntries=1
...
```js live showLines consoleEntries=3
function sayHello(name) {
  console.log(`Hello ${name}!`);
}
...
```js live showLines showConsole consoleEntries=3
...
```js live showLines consoleEntries=6
function sayHello(name) {
  console.log(`Hello ${name}!`);
}
...
```js live showConsole consoleEntries=1
const friends = [
  'Charlie Brown',
  'Sally Brown',
  'Lucy Van Pelt',
...
```js live showConsole consoleEntries=12
...
```js live showConsole consoleEntries=6
function countdown(time) {
  console.log(time);
  if (time <= 0) {
    return;
...
```js live showConsole consoleEntries=7
const friends = [
  'Charlie Brown',
  'Sally Brown',
  'Lucy Van Pelt',
